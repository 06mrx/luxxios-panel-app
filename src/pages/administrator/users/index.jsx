...
export default function Index() {
    ...
    const { data: datas, mutate, isLoading: datasLoading } = useSWR('/api/administrator/user/index?page=' + (ROUTER.query.page ? ROUTER.query.page : ''), fetcher)
    ...
    return <>
        ...
        <ToastContainer/>
        <NewPageLayout title={'Daftar Pengguna'} hasBackURL backURL="/administrator">
            <div className="mt-3">
                <Table isCompact>
                    <thead>
        ...
        <Modal id={'delete-modal'} title={'Hapus Data'}>
            <p className="py-3">Apakah anda yakin ingin menghapus user <span className="font-semibold">{selected?.email}</span></p>
