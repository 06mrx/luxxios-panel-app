...
export default function Index() {
    ...
    const { data: datas, mutate, isLoading: datasLoading } = useSWR('/api/administrator/studio/index?page=' + (ROUTER.query.page ? ROUTER.query.page : ''), fetcher)
    ...
    const handleDelete = () => {
        setLoading(true);
        fetch(process.env.API + '/api/administrator/studio/destroy/' + selected?.id, {
            method: 'DELETE',
            headers: {
                'authorization': TOKEN
            },
    ...
    return <>
        ...
        <ToastContainer />
        <NewPageLayout title={'Pendaftaran Sanggar'} hasBackURL backURL="/administrator">
            <div className="mt-3">
                <Table isCompact>
                    <thead>
                                    ...
                                    <tr key={index} className="hover text-center">
                                        ...
                                        <td>
                                            <div className="flex w-full gap-3 justify-end">
                                                ...
                                                <ShowButton url={'/administrator/studio/' + data.id} />
                                            </div>
                                        </td>
                                    </tr>
                                )
